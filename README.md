...
```bash
curl -L -O "https://github.com/g5ostXa/mnstrsay/releases/download/v0.1.2/mnstrsay-v0.1.2-linux-amd64"
curl -L -O "https://github.com/g5ostXa/mnstrsay/releases/download/v0.1.2/sha256sum.txt"
```
...
```
mnstrsay-v0.1.2-linux-amd64: OK
```
